...
// --- 데이터 영역 ---
// 기능 카드에 들어갈 내용을 배열로 관리하여 코드의 재사용성을 높입니다.
const featuresData = [
  {
    title: "AI 코디 추천",
  ...
  {
    title: "내 옷장 원격 관리",
    description: "언제 어디서든 스마트폰 앱으로 내 옷장의 모든 것을 확인하고 제어합니다.",
    icon: (
...
const Header = () => (
  <header className="w-full bg-white text-gray-800 py-6 text-center shadow-md">
    ...
    <p className="mt-2 text-lg text-gray-600">당신의 일상을 변화시킬 단 하나의 스마트 옷장</p>
  </header>
);
...
const MainBanner = () => (
  <section className="w-full max-w-5xl my-10 bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-xl rounded-2xl p-10 text-center">
    <h2 className="text-3xl font-semibold mb-4">세상에 없던 의류 케어, Dumir가 시작합니다.</h2>
    <p className="text-indigo-100 mb-8 text-lg">혁신적인 AI 기술로 코디 추천부터 의류 관리, 원격 제어까지.<br />이제껏 경험하지 못한 스마트한 의류 라이프를 만나보세요.</p>
    <button className="px-8 py-3 bg-white text-blue-600 font-semibold rounded-xl hover:bg-gray-100 transition shadow-lg">주요 기능 시연하기</button>
  </section>
);

// 기능 카드 컴포넌트 (데이터를 받아와서 UI를 그림)
...
// --- 메인 App 컴포넌트 ---
// 위에서 만든 작은 컴포넌트들을 조립하여 전체 페이지를 완성합니다.
function App() {
  return (
